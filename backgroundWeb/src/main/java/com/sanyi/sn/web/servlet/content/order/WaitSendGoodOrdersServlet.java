 ...
 * @copy 老九学堂
 */
@WebServlet("/pageContent/order/allOrder/waitSendGood")
public class WaitSendGoodOrdersServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        OrderService orderService = OrderServiceImpl.newObj();
        List<SimpleOrderMessageVo> simpleOrderMessageVoList = orderService.getOrderSimpleMessage(0,5,"待发货");
